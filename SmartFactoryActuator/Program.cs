...
Console.WriteLine($"  Infeed Conveyor    : {InfeedPort}");
Console.WriteLine($"  Pneumatic Pressure : {PneumaticPort}");
Console.WriteLine($"  Vibration          : {VibrationPort}");
Console.WriteLine($"  Reject Cylinder    : {RejectPort}");
Console.WriteLine($"  Inspection Conveyor: {InspectionPort}");
